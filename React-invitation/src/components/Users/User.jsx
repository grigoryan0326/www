...
export const User = ({ user, invites, setInvites }) => (
  <li>
    <div>
    ...
    {invites.find((invite) => invite.email === user.email) ? <img className="action" src="/assets/minus.svg" onClick={() => setInvites(invites.filter((invite) => invite.id !== user.id))} alt="Action" /> : <img className="action" src="/assets/plus.svg" onClick={() => setInvites([...invites, user])} alt="Action" />}
  </li>
);
